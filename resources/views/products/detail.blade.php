...
@section('content')
    <div class="container p-t-80">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="/producttype/{{ $product->producttype->id }}-{{ Str::slug($product->producttype->name) }}.html"
                            ...
                            <div class="slick3 gallery-lb slick-initialized slick-slider slick-dotted">
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        @foreach($product->productimages as $index => $productimage)
                                        <div class="item-slick3 slick-slide {{ $index === 0 ? 'slick-current slick-active' : '' }} thumbnail-item"
                                                data-file="{{ $productimage->image_path }}" data-slick-index="{{ $index }}"
                                                aria-hidden="false"
                                                style="width: 513px; position: relative; left: {{ $index * 513 }}px; top: 0px; z-index: 999; opacity: 1;"
                                                tabindex="{{ $index }}" role="tabpanel" id="slick-slide{{ $index + 10 }}"
                                                ...
                                                <div class="wrap-pic-w pos-relative">
                                                    ...
                                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                        href="{{ $productimage->image_path }}" tabindex="{{ $index }}">
